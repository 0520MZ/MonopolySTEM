...
public class Monopoly {
    ...
    static class Game {
        ...
        private void setupBoard() {
            ...
            //New property type for Railroad?? Rent doesn't really fit in current functionalities,
            board.add(new Property("Oriental Avenue",  100, 6));
            board.add(new Property("Vermont Avenue", 100, 6));
            board.add(new Property("Connecticut Avenue", 120, 8));
            board.add(new Property("St. Charles Place", 130, 10));
            board.add(new Property("States Avenue", 140, 10));
            board.add(new Property("Virginia Avenue", 160, 12));
